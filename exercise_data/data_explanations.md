...
18 = EEG recording of a patient from the Siena Scalp EEG Database. Column 1 is the time in seconds, column 2 is the measured EEG signal at electrode F8 (right frontal region, patient has right-hemisphere seizures). The seizure in the recording is documented to have started at t=1143.0s and ended at t=1213.0s. This time series was downloaded from https://physionet.org/files/siena-scalp-eeg/1.0.0/PN00/PN00-1.edf and converted into the csv format using convert_18.py